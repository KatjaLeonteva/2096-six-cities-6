export default [
  ...
  },
  {
    ...
    description: `Design interior in most sympathetic area! Complitely renovated, well-equipped, cosy studio in idyllic, over 100 years old wooden house. Calm street, fast connection to center and airport.`,
    goods: [`Baby seat`, `Air conditioning`, `Washer`, `Breakfast`, `Laptop friendly workspace`, `Towels`],
    host: {
      avatarUrl: `img/avatar-angelina.jpg`,
      id: 3,
      isPro: true,
  ...
  },
  {
    ...
    goods: [`Breakfast`, `Laptop friendly workspace`, `Fridge`, `Washer`, `Air conditioning`, `Baby seat`, `Towels`],
    host: {
      avatarUrl: `img/avatar-angelina.jpg`,
      id: 3,
      isPro: true,
  ...
  },
  {
    ...
    goods: [`Fridge`, `Coffee machine`, `Washer`, `Air conditioning`, `Washing machine`, `Laptop friendly workspace`, `Towels`, `Dishwasher`, `Baby seat`, `Cable TV`, `Breakfast`],
    host: {
      avatarUrl: `img/avatar-angelina.jpg`,
      id: 3,
      isPro: true,
